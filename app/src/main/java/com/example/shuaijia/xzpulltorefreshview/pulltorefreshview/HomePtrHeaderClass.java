...
public class HomePtrHeaderClass extends RefreshHeaderBase {
    private static final String TAG = "HomePtrHeaderClass";
    ...
    public HomePtrHeaderClass(Context context) {
        super(context);
        initViews();
    }

    public HomePtrHeaderClass(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews();
    }

    public HomePtrHeaderClass(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initViews();
    }

    private void initViews() {
        View header = LayoutInflater.from(getContext()).inflate(R.layout.prt_pulldown_layout, this);
...
//        invalidate();
    ...
    public void onUIPositionChange(PtrFrameLayout frame, boolean isUnderTouch, byte status, PtrIndicator ptrIndicator) {
        ...
        scrollListener.scroll(currentPos);
